"""
# dentro do ambiente virtual foi usado duas bibliotecas "pip install pillow openpyxl"
...
for indice, linha in enumerate(sheet_alunos.iter_rows(min_row=2)):
    ...
    desenhar.text((1480, 1182), f'{str(carga_horaria)} horas', fill='black', font=fonte_geral)
